...
\midrule
Pure Vector  & 0.500 & \textbf{0.663} {\scriptsize[0.635, 0.690]} & 0.152 & 0.836 & \textbf{0.727} & 10{,}914 & -- \\
...
Single-stage & 0.737 & 0.457 {\scriptsize[0.430, 0.486]} & 0.130 & 0.735 & 0.215 & 7{,}262 & 0.0\% \\
Two-stage (ours) & 0.623 & 0.602 {\scriptsize[0.576, 0.628]} & 0.243 & 0.815 & 0.508 & 9{,}799 & 79.2\% \\
Always-on Stage~2 & 0.455 & 0.682 {\scriptsize[0.656, 0.706]} & 0.335 & 0.861 & 0.588 & 10{,}270 & 100.0\% \\
\midrule
...
\midrule
        \textbf{Two-stage (selective)} & 0.646 & 0.509 & 0.607 \\
        \textbf{Always-on}             & \textbf{0.806} & 0.481 & 0.633 \\
        Oracle                         & 0.466 & 0.515 & \textbf{0.649} \\
        Oracle + Stage 2               & 0.661 & 0.499 & 0.640 \\ \midrule
        Pure Vector                    & 0.619 & 0.701 & 0.637 \\
        Pure Graph                     & 0.815 & 0.526 & 0.456 \\
        Pure Hybrid                    & 0.574 & \textbf{0.790} & 0.649 \\
...
overhead is $\approx\!3{,}181$~ms at the $79.2\%$ trigger rate.
