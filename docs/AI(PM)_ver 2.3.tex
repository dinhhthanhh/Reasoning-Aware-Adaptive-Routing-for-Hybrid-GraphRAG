...
clarification queries. On the original constructed ambiguity
benchmark, the initial Stage~2 configuration increases
clarification F1 to $0.684$ with precision $1.000$. After
adding deterministic history-referent resolution and a
severe-ambiguity override policy, the same ambiguity benchmark
improves to clarification F1 $=0.840$. On a separate
